...
@section('css')
    <link href='{{ url('/') }}/lib/fullcalendar/css/fullcalendar.min.css' rel='stylesheet' />
    <link href='{{ url('/') }}/lib/fullcalendar/css/fullcalendar.print.min.css' rel='stylesheet' media='print' />
    <style>
        .fc-content {
            color: #fff;
        }
...
@section('script')
    <script src='{{ url('/') }}/lib/fullcalendar/js/moment.min.js'></script>
    <script src='{{ url('/') }}/lib/fullcalendar/js/fullcalendar.min.js'></script>
    <script src='{{ url('/') }}/lib/fullcalendar/js/theme-chooser.js'></script>
    <script>
